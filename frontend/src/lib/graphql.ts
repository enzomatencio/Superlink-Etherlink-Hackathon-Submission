...
const GRAPH_ENDPOINT = import.meta.env.VITE_GRAPH_ENDPOINT || 'https://api.studio.thegraph.com/query/117578/superlink-usd-vault/v2.0.1-correct-vault'
...
export class GraphQLService {
  async getAllActivities(first: number = 100): Promise<VaultActivity[]> {
    console.log('🔗 Fetching activities from The Graph...')
